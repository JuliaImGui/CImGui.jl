...
function Base.getproperty(x::Ptr{ImGuiWindow}, f::Symbol)
    ...
    f === :BgClickFlags && return (Ptr{ImGuiWindowBgClickFlags}(x + 280), 24, 8)
    f === :SetWindowPosAllowFlags && return (Ptr{ImGuiCond}(x + 284), 0, 8)
    f === :SetWindowSizeAllowFlags && return (Ptr{ImGuiCond}(x + 284), 8, 8)
    f === :SetWindowCollapsedAllowFlags && return (Ptr{ImGuiCond}(x + 284), 16, 8)
    f === :SetWindowDockAllowFlags && return (Ptr{ImGuiCond}(x + 284), 24, 8)
    f === :SetWindowPosVal && return Ptr{ImVec2}(x + 288)
    f === :SetWindowPosPivot && return Ptr{ImVec2}(x + 296)
    f === :IDStack && return Ptr{ImVector_ImGuiID}(x + 304)
    f === :DC && return Ptr{ImGuiWindowTempData}(x + 316)
    ...
    f === :ColumnsStorage && return Ptr{ImVector_ImGuiOldColumns}(x + 708)
    f === :FontWindowScale && return Ptr{Cfloat}(x + 720)
    f === :FontWindowScaleParents && return Ptr{Cfloat}(x + 724)
    f === :FontRefSize && return Ptr{Cfloat}(x + 728)
    f === :SettingsOffset && return Ptr{Cint}(x + 732)
    f === :DrawList && return Ptr{Ptr{ImDrawList}}(x + 736)
    f === :DrawListInst && return Ptr{ImDrawList}(x + 740)
    f === :ParentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 904)
    f === :ParentWindowInBeginStack && return Ptr{Ptr{ImGuiWindow}}(x + 908)
    f === :RootWindow && return Ptr{Ptr{ImGuiWindow}}(x + 912)
    f === :RootWindowPopupTree && return Ptr{Ptr{ImGuiWindow}}(x + 916)
    f === :RootWindowDockTree && return Ptr{Ptr{ImGuiWindow}}(x + 920)
    f === :RootWindowForTitleBarHighlight && return Ptr{Ptr{ImGuiWindow}}(x + 924)
    f === :RootWindowForNav && return Ptr{Ptr{ImGuiWindow}}(x + 928)
    f === :ParentWindowForFocusRoute && return Ptr{Ptr{ImGuiWindow}}(x + 932)
    f === :NavLastChildNavWindow && return Ptr{Ptr{ImGuiWindow}}(x + 936)
    f === :NavLastIds && return Ptr{NTuple{2, ImGuiID}}(x + 940)
    f === :NavRectRel && return Ptr{NTuple{2, ImRect}}(x + 948)
    f === :NavPreferredScoringPosRel && return Ptr{NTuple{2, ImVec2}}(x + 980)
    f === :NavRootFocusScopeId && return Ptr{ImGuiID}(x + 996)
    f === :MemoryDrawListIdxCapacity && return Ptr{Cint}(x + 1000)
    f === :MemoryDrawListVtxCapacity && return Ptr{Cint}(x + 1004)
    f === :MemoryCompacted && return Ptr{Bool}(x + 1008)
    f === :DockIsActive && return (Ptr{Bool}(x + 1008), 8, 1)
    f === :DockNodeIsVisible && return (Ptr{Bool}(x + 1008), 9, 1)
    f === :DockTabIsVisible && return (Ptr{Bool}(x + 1008), 10, 1)
    f === :DockTabWantClose && return (Ptr{Bool}(x + 1008), 11, 1)
    f === :DockOrder && return Ptr{Cshort}(x + 1010)
    f === :DockStyle && return Ptr{ImGuiWindowDockStyle}(x + 1012)
    f === :DockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 1048)
    f === :DockNodeAsHost && return Ptr{Ptr{ImGuiDockNode}}(x + 1052)
    f === :DockId && return Ptr{ImGuiID}(x + 1056)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiListClipper}, f::Symbol)
    ...
    f === :StartPosY && return Ptr{Cdouble}(x + 20)
    f === :StartSeekOffsetY && return Ptr{Cdouble}(x + 28)
    f === :TempData && return Ptr{Ptr{Cvoid}}(x + 36)
    f === :Flags && return Ptr{ImGuiListClipperFlags}(x + 40)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    ...
    f === :Style && return Ptr{ImGuiStyle}(x + 3224)
    f === :ConfigFlagsCurrFrame && return Ptr{ImGuiConfigFlags}(x + 4552)
    f === :ConfigFlagsLastFrame && return Ptr{ImGuiConfigFlags}(x + 4556)
    f === :FontAtlases && return Ptr{ImVector_ImFontAtlasPtr}(x + 4560)
    f === :Font && return Ptr{Ptr{ImFont}}(x + 4572)
    f === :FontBaked && return Ptr{Ptr{ImFontBaked}}(x + 4576)
    f === :FontSize && return Ptr{Cfloat}(x + 4580)
    f === :FontSizeBase && return Ptr{Cfloat}(x + 4584)
    f === :FontBakedScale && return Ptr{Cfloat}(x + 4588)
    f === :FontRasterizerDensity && return Ptr{Cfloat}(x + 4592)
    f === :CurrentDpiScale && return Ptr{Cfloat}(x + 4596)
    f === :DrawListSharedData && return Ptr{ImDrawListSharedData}(x + 4600)
    f === :WithinEndChildID && return Ptr{ImGuiID}(x + 5140)
    f === :TestEngine && return Ptr{Ptr{Cvoid}}(x + 5144)
    f === :InputEventsQueue && return Ptr{ImVector_ImGuiInputEvent}(x + 5148)
    f === :InputEventsTrail && return Ptr{ImVector_ImGuiInputEvent}(x + 5160)
    f === :InputEventsNextMouseSource && return Ptr{ImGuiMouseSource}(x + 5172)
    f === :InputEventsNextEventId && return Ptr{ImU32}(x + 5176)
    f === :Windows && return Ptr{ImVector_ImGuiWindowPtr}(x + 5180)
    f === :WindowsFocusOrder && return Ptr{ImVector_ImGuiWindowPtr}(x + 5192)
    f === :WindowsTempSortBuffer && return Ptr{ImVector_ImGuiWindowPtr}(x + 5204)
    f === :CurrentWindowStack && return Ptr{ImVector_ImGuiWindowStackData}(x + 5216)
    f === :WindowsById && return Ptr{ImGuiStorage}(x + 5228)
    f === :WindowsActiveCount && return Ptr{Cint}(x + 5240)
    f === :WindowsBorderHoverPadding && return Ptr{Cfloat}(x + 5244)
    f === :DebugBreakInWindow && return Ptr{ImGuiID}(x + 5248)
    f === :CurrentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5252)
    f === :HoveredWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5256)
    f === :HoveredWindowUnderMovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5260)
    f === :HoveredWindowBeforeClear && return Ptr{Ptr{ImGuiWindow}}(x + 5264)
    f === :MovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5268)
    f === :WheelingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5272)
    f === :WheelingWindowRefMousePos && return Ptr{ImVec2}(x + 5276)
    f === :WheelingWindowStartFrame && return Ptr{Cint}(x + 5284)
    f === :WheelingWindowScrolledFrame && return Ptr{Cint}(x + 5288)
    f === :WheelingWindowReleaseTimer && return Ptr{Cfloat}(x + 5292)
    f === :WheelingWindowWheelRemainder && return Ptr{ImVec2}(x + 5296)
    f === :WheelingAxisAvg && return Ptr{ImVec2}(x + 5304)
    f === :DebugDrawIdConflictsId && return Ptr{ImGuiID}(x + 5312)
    f === :DebugHookIdInfoId && return Ptr{ImGuiID}(x + 5316)
    f === :HoveredId && return Ptr{ImGuiID}(x + 