...
function Base.getproperty(x::Ptr{ImGuiViewport}, f::Symbol)
    ...
    f === :PlatformHandleRaw && return Ptr{Ptr{Cvoid}}(x + 76)
    f === :PlatformWindowCreated && return Ptr{Bool}(x + 80)
    f === :PlatformRequestMove && return Ptr{Bool}(x + 81)
    f === :PlatformRequestResize && return Ptr{Bool}(x + 82)
    f === :PlatformRequestClose && return Ptr{Bool}(x + 83)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImFontConfig}, f::Symbol)
    ...
    f === :FontLoaderData && return Ptr{Ptr{Cvoid}}(x + 116)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiPlatformIO}, f::Symbol)
    ...
    f === :Platform_CreateWindow && return Ptr{Ptr{Cvoid}}(x + 44)
    f === :Platform_DestroyWindow && return Ptr{Ptr{Cvoid}}(x + 48)
    f === :Platform_ShowWindow && return Ptr{Ptr{Cvoid}}(x + 52)
    f === :Platform_SetWindowPos && return Ptr{Ptr{Cvoid}}(x + 56)
    f === :Platform_GetWindowPos && return Ptr{Ptr{Cvoid}}(x + 60)
    f === :Platform_SetWindowSize && return Ptr{Ptr{Cvoid}}(x + 64)
    f === :Platform_GetWindowSize && return Ptr{Ptr{Cvoid}}(x + 68)
    f === :Platform_GetWindowFramebufferScale && return Ptr{Ptr{Cvoid}}(x + 72)
    f === :Platform_SetWindowFocus && return Ptr{Ptr{Cvoid}}(x + 76)
    f === :Platform_GetWindowFocus && return Ptr{Ptr{Cvoid}}(x + 80)
    f === :Platform_GetWindowMinimized && return Ptr{Ptr{Cvoid}}(x + 84)
    f === :Platform_SetWindowTitle && return Ptr{Ptr{Cvoid}}(x + 88)
    f === :Platform_SetWindowAlpha && return Ptr{Ptr{Cvoid}}(x + 92)
    f === :Platform_UpdateWindow && return Ptr{Ptr{Cvoid}}(x + 96)
    f === :Platform_RenderWindow && return Ptr{Ptr{Cvoid}}(x + 100)
    f === :Platform_SwapBuffers && return Ptr{Ptr{Cvoid}}(x + 104)
    f === :Platform_GetWindowDpiScale && return Ptr{Ptr{Cvoid}}(x + 108)
    f === :Platform_OnChangedViewport && return Ptr{Ptr{Cvoid}}(x + 112)
    f === :Platform_GetWindowWorkAreaInsets && return Ptr{Ptr{Cvoid}}(x + 116)
    f === :Platform_CreateVkSurface && return Ptr{Ptr{Cvoid}}(x + 120)
    f === :Renderer_CreateWindow && return Ptr{Ptr{Cvoid}}(x + 124)
    f === :Renderer_DestroyWindow && return Ptr{Ptr{Cvoid}}(x + 128)
    f === :Renderer_SetWindowSize && return Ptr{Ptr{Cvoid}}(x + 132)
    f === :Renderer_RenderWindow && return Ptr{Ptr{Cvoid}}(x + 136)
    f === :Renderer_SwapBuffers && return Ptr{Ptr{Cvoid}}(x + 140)
    f === :Monitors && return Ptr{ImVector_ImGuiPlatformMonitor}(x + 144)
    f === :Textures && return Ptr{ImVector_ImTextureDataPtr}(x + 156)
    f === :Viewports && return Ptr{ImVector_ImGuiViewportPtr}(x + 168)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiWindow}, f::Symbol)
    ...
    f === :ScrollbarXStabilizeEnabled && return Ptr{Bool}(x + 242)
    f === :ScrollbarXStabilizeToggledHistory && return Ptr{ImU8}(x + 243)
    f === :ViewportOwned && return Ptr{Bool}(x + 244)
    f === :Active && return Ptr{Bool}(x + 245)
    f === :WasActive && return Ptr{Bool}(x + 246)
    f === :WriteAccessed && return Ptr{Bool}(x + 247)
    f === :Collapsed && return Ptr{Bool}(x + 248)
    f === :WantCollapseToggle && return Ptr{Bool}(x + 249)
    f === :SkipItems && return Ptr{Bool}(x + 250)
    f === :SkipRefresh && return Ptr{Bool}(x + 251)
    f === :Appearing && return Ptr{Bool}(x + 252)
    f === :Hidden && return Ptr{Bool}(x + 253)
    f === :IsFallbackWindow && return Ptr{Bool}(x + 254)
    f === :IsExplicitChild && return Ptr{Bool}(x + 255)
    f === :HasCloseButton && return Ptr{Bool}(x + 256)
    f === :ResizeBorderHovered && return Ptr{Int8}(x + 257)
    f === :ResizeBorderHeld && return Ptr{Int8}(x + 258)
    f === :BeginCount && return Ptr{Cshort}(x + 260)
    f === :BeginCountPreviousFrame && return Ptr{Cshort}(x + 262)
    f === :BeginOrderWithinParent && return Ptr{Cshort}(x + 264)
    f === :BeginOrderWithinContext && return Ptr{Cshort}(x + 266)
    f === :FocusOrder && return Ptr{Cshort}(x + 268)
    f === :AutoPosLastDirection && return Ptr{ImGuiDir}(x + 272)
    f === :AutoFitFramesX && return Ptr{ImS8}(x + 276)
    f === :AutoFitFramesY && return Ptr{ImS8}(x + 277)
    f === :AutoFitOnlyGrows && return Ptr{Bool}(x + 278)
    f === :HiddenFramesCanSkipItems && return Ptr{ImS8}(x + 279)
    f === :HiddenFramesCannotSkipItems && return Ptr{ImS8}(x + 280)
    f === :HiddenFramesForRenderOnly && return Ptr{ImS8}(x + 281)
    f === :DisableInputsFrames && return Ptr{ImS8}(x + 282)
    f === :BgClickFlags && return (Ptr{ImGuiWindowBgClickFlags}(x + 284), 0, 8)
    f === :SetWindowPosAllowFlags && return (Ptr{ImGuiCond}(x + 284), 8, 8)
    f === :SetWindowSizeAllowFlags && return (Ptr{ImGuiCond}(x + 284), 16, 8)
    f === :SetWindowCollapsedAllowFlags && return (Ptr{ImGuiCond}(x + 284), 24, 8)
    f === :SetWindowDockAllowFlags && return (Ptr{ImGuiCond}(x + 288), 0, 8)
    ...
    f === :OuterRectClipped && return Ptr{ImRect}(x + 564)
    f === :InnerRect && return Ptr{ImRect}(x + 580)
    f === :InnerClipRect && return Ptr{ImRect}(x + 596)
    f === :WorkRect && return Ptr{ImRect}(x + 612)
    f === :ParentWorkRect && return Ptr{ImRect}(x + 628)
    f === :ClipRect && return Ptr{ImRect}(x + 644)
    f === :ContentRegionRect && return Ptr{ImRect}(x + 660)
    f === :HitTestHoleSize && return Ptr{ImVec2ih}(x + 676)
    f === :HitTestHoleOffset && return Ptr{ImVec2ih}(x + 680)
    f === :LastFrameActive && return Ptr{Cint}(x + 684)
    f === :LastFrameJustFocused && return Ptr{Cint}(x + 688)
    f === :LastTimeActive && return Ptr{Cfloat}(x + 692)
    f === :ItemWidthDefault && return Ptr{Cfloat}(x + 696)
...
function Base.getproperty(x::Ptr{ImGuiListClipper}, f::Symbol)
    ...
    f === :Flags && return Ptr{ImGuiListClipperFlags}(x + 44)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiTable}, f::Symbol)
    ...
    f === :NavLayer && return Ptr{ImS8}(x + 490)
    f === :IsLayoutLocked && return Ptr{Bool}(x + 491)
    f === :IsInsideRow && return Ptr{Bool}(x + 492)
    f === :IsInitializing && return Ptr{Bool}(x + 493)
    f === :IsSortSpecsDirty && return Ptr{Bool}(x + 494)
    f === :IsUsingHeaders && return Ptr{Bool}(x + 495)
    f === :IsContextPopupOpen && return Ptr{Bool}(x + 496)
    f === :DisableDefaultContextMenu && return Ptr{Bool}(x + 497)
    f === :IsSettingsRequestLoad && return Ptr{Bool}(x + 498)
    f === :IsSettingsDirty && return Ptr{Bool}(x + 499)
    f === :IsDefaultDisplayOrder && return Ptr{Bool}(x + 500)
    f === :IsResetAllRequest && return Ptr{Bool}(x + 501)
    f === :IsResetDisplayOrderRequest && return Ptr{Bool}(x + 502)
    f === :IsUnfrozenRows && return Ptr{Bool}(x + 503)
    f === :IsDefaultSizingPolicy && return Ptr{Bool}(x + 504)
    f === :IsActiveIdAliveBeforeTable && return Ptr{Bool}(x + 505)
    f === :IsActiveIdInTable && return Ptr{Bool}(x + 506)
    f === :HasScrollbarYCurr && return Ptr{Bool}(x + 507)
    f === :HasScrollbarYPrev && return Ptr{Bool}(x + 508)
    f === :MemoryCompacted && return Ptr{Bool}(x + 509)
    f === :HostSkipItems && return Ptr{Bool}(x + 510)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    ...
    f === :ConfigFlagsCurrFrame && return Ptr{ImGuiConfigFlags}(x + 4564)
    f === :ConfigFlagsLastFrame && return Ptr{ImGuiConfigFlags}(x + 4568)
    f === :FontAtlases && return Ptr{ImVector_ImFontAtlasPtr}(x + 4572)
    f === :Font && return Ptr{Ptr{ImFont}}(x + 4584)
    f === :FontBaked && return Ptr{Ptr{ImFontBaked}}(x + 4588)
    f === :FontSize && return Ptr{Cfloat}(x + 4592)
    f === :FontSizeBase && return Ptr{Cfloat}(x + 4596)
    f === :FontBakedScale && return Ptr{Cfloat}(x + 4600)
    f === :FontRasterizerDensity && return Ptr{Cfloat}(x + 4604)
    f === :CurrentDpiScale && return Ptr{Cfloat}(x + 4608)
    f === :DrawListSharedData && return Ptr{ImDrawListSharedData}(x + 4612)
    f === :WithinEndChildID && return Ptr{ImGuiID}(x + 5152)
    f === :TestEngine && return Ptr{Ptr{Cvoid}}(x + 5156)
    f === :InputEventsQueue && return Ptr{ImVector_ImGuiInputEvent}(x + 5160)
    f === :InputEventsTrail && return Ptr{ImVector_ImGuiInputEvent}(x + 5172)
    f === :InputEventsNextMouseSource && return Ptr{ImGuiMouseSource}(x + 5184)
    f === :InputEventsNextEventId && return Ptr{ImU32}(x + 5188)
    f === :Windows && return Ptr{ImVector_ImGuiWindowPtr}(x + 5192)
    f === :WindowsFocusOrder && return Ptr{ImVector_ImGuiWindowPtr}(x + 5204)
    f === :WindowsTempSortBuffer && return Ptr{ImVector_ImGuiWindowPtr}(x + 5216)
    f === :CurrentWindowStack && return Ptr{ImVector_ImGuiWindowStackData}(x + 5228)
    f === :WindowsById && return Ptr{ImGuiStorage}(x + 5240)
    f === :WindowsActiveCount && return Ptr{Cint}(x + 5252)
    f === :WindowsBorderHoverPadding && return Ptr{Cfloat}(x + 5256)
    f === :DebugBreakInWindow && return Ptr{ImGuiID}(x + 5260)
    f === :CurrentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5264)
    f === :HoveredWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5268)
    f === :HoveredWindowUnderMovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5272)
    f === :HoveredWindowBeforeClear && return Ptr{Ptr{ImGuiWindow}}(x + 5276)
    f === :MovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5280)
    f === :WheelingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5284)
    f === :WheelingWindowRefMousePos && return Ptr{ImVec2}(x + 5288)
    f === :WheelingWindowStartFrame && return Ptr{Cint}(x + 5296)
    f === :WheelingWindowScrolledFrame && return Ptr{Cint}(x + 5300)
    f === :WheelingWindowReleaseTimer && return Ptr{Cfloat}(x + 5304)
    f === :WheelingWindowWheelRemainder && return Ptr{ImVec2}(x + 5308)
    f === :WheelingAxisAvg && return Ptr{ImVec2}(x + 5316)
    f === :DebugDrawIdConflictsId && return Ptr{ImGuiID}(x + 5324)
    f === :DebugHookIdInfoId && return Ptr{ImGuiID}(x + 5328)
    f === :HoveredId && return Ptr{ImGuiID}(x + 5332)
    f === :HoveredIdPreviousFrame && return Ptr{ImGuiID}(x + 5336)
    f === :HoveredIdPreviousFrameItemCount && return Ptr{Cint}(x + 5340)
    ...
    f === :ActiveIdMouseButton && return Ptr{ImS8}(x + 5375)
    f === :ActiveIdDisabledId && return Ptr{ImGuiID}(x + 5376)
    f === :ActiveIdClickOffset && return Ptr{ImVec2}(x + 5380)
    f === :ActiveIdSource && return Ptr{ImGuiInputSource}(x + 5388)
    f === :ActiveIdWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5392)
    f === :ActiveIdPreviousFrame && return Ptr{ImGuiID}(x + 5396)
    f === :DeactivatedItemData && return Ptr{ImGuiDeactivatedItemData}(x + 5400)
    f === :ActiveIdValueOnActivation && return Ptr{ImGuiDataTypeStorage}(x + 5412)
    f === :LastActiveId && return Ptr{ImGuiID}(x + 5420)
    f === :LastActiveIdTimer && return Ptr{Cfloat}(x + 5424)
    ...
    f === :KeysOwnerData && return Ptr{NTuple{155, ImGuiKeyOwnerData}}(x + 5476)
    ...
    f === :GcCompactAll && return Ptr{Bool}(x + 7985)
    f === :DebugFlashStyleColorIdx && return Ptr{ImGuiCol}(x + 7988)
    f === :ColorStack && return Ptr{ImVector_ImGuiColorMod}(x + 7992)
    f === :StyleVarStack && return Ptr{ImVector_ImGuiStyleMod}(x + 8004)
    f === :FontStack && return Ptr{ImVector_ImFontStackData}(x + 8016)
    f === :FocusScopeStack && return Ptr{ImVector_ImGuiFocusScopeData}(x + 8028)
    f === :ItemFlagsStack && return Ptr{ImVector_ImGuiItemFlags}(x + 8040)
    f === :GroupStack && return Ptr{ImVector_ImGuiGroupData}(x + 8052)
    f === :OpenPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 8064)
    f === :BeginPopupStack && return Ptr{ImVector_ImGuiPopupData}(x + 8076)
    f === :TreeNodeStack && return Ptr{ImVector_ImGuiTreeNodeStackData}(x + 8088)
    f === :Viewports && return Ptr{ImVector_ImGuiViewportPPtr}(x + 8100)
    f === :CurrentViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8112)
    f === :MouseViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8116)
    f === :MouseLastHoveredViewport && return Ptr{Ptr{ImGuiViewportP}}(x + 8120)
    f === :PlatformLastFocusedViewportId && return Ptr{ImGuiID}(x + 8124)
    f === :FallbackMonitor && return Ptr{ImGuiPlatformMonitor}(x + 8128)
    f === :PlatformMonitorsFullWorkRect && return Ptr{ImRect}(x + 8168)
    f === :ViewportCreatedCount && return Ptr{Cint}(x + 8184)
    f === :PlatformWindowsCreatedCount && return Ptr{Cint}(x + 8188)
    f === :ViewportFocusedStampCount && return Ptr{Cint}(x + 8192)
    f === :NavCursorVisible && return Ptr{Bool}(x + 8196)
    f === :NavHighlightItemUnderNav && return Ptr{Bool}(x + 8197)
    f === :NavMousePosDirty && return Ptr{Bool}(x + 8198)
    f === :NavIdIsAlive && return Ptr{Bool}(x + 8199)
    f === :NavId && return Ptr{ImGuiID}(x + 8200)
    f === :NavWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8204)
    f === :NavFocusScopeId && return Ptr{ImGuiID}(x + 8208)
    f === :NavLayer && return Ptr{ImGuiNavLayer}(x + 8212)
    f === :NavActivateId && return Ptr{ImGuiID}(x + 8216)
    f === :NavActivateDownId && return Ptr{ImGuiID}(x + 8220)
    f === :NavActivatePressedId && return Ptr{ImGuiID}(x + 8224)
    f === :NavActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8228)
    f === :NavFocusRoute && return Ptr{ImVector_ImGuiFocusScopeData}(x + 8232)
    f === :NavHighlightActivatedId && return Ptr{ImGuiID}(x + 8244)
    f === :NavHighlightActivatedTimer && return Ptr{Cfloat}(x + 8248)
    f === :NavNextActivateId && return Ptr{ImGuiID}(x + 8252)
    f === :NavNextActivateFlags && return Ptr{ImGuiActivateFlags}(x + 8256)
    f === :NavInputSource && return Ptr{ImGuiInputSource}(x + 8260)
    f === :NavLastValidSelectionUserData && return Ptr{ImGuiSelectionUserData}(x + 8264)
    f === :NavCursorHideFrames && return Ptr{ImS8}(x + 8272)
    f === :NavAnyRequest && return Ptr{Bool}(x + 8273)
    f === :NavInitRequest && return Ptr{Bool}(x + 8274)
    f === :NavInitRequestFromMove && return Ptr{Bool}(x + 8275)
    f === :NavInitResult && return Ptr{ImGuiNavItemData}(x + 8280)
    f === :NavMoveSubmitted && return Ptr{Bool}(x + 8336)
    f === :NavMoveScoringItems && return Ptr{Bool}(x + 8337)
    f === :NavMoveForwardToNextFrame && return Ptr{Bool}(x + 8338)
    f === :NavMoveFlags && return Ptr{ImGuiNavMoveFlags}(x + 8340)
    f === :NavMoveScrollFlags && return Ptr{ImGuiScrollFlags}(x + 8344)
    f === :NavMoveKeyMods && return Ptr{ImGuiKeyChord}(x + 8348)
    f === :NavMoveDir && return Ptr{ImGuiDir}(x + 8352)
    f === :NavMoveDirForDebug && return Ptr{ImGuiDir}(x + 8356)
    f === :NavMoveClipDir && return Ptr{ImGuiDir}(x + 8360)
    f === :NavScoringRect && return Ptr{ImRect}(x + 8364)
    f === :NavScoringNoClipRect && return Ptr{ImRect}(x + 8380)
    f === :NavScoringDebugCount && return Ptr{Cint}(x + 8396)
    f === :NavTabbingDir && return Ptr{Cint}(x + 8400)
    f === :NavTabbingCounter && return Ptr{Cint}(x + 8404)
    f === :NavMoveResultLocal && return Ptr{ImGuiNavItemData}(x + 8408)
    f === :NavMoveResultLocalVisible && return Ptr{ImGuiNavItemData}(x + 8464)
    f === :NavMoveResultOther && return Ptr{ImGuiNavItemData}(x + 8520)
    f === :NavTabbingResultFirst && return Ptr{ImGuiNavItemData}(x + 8576)
    f === :NavJustMovedFromFocusScopeId && return Ptr{ImGuiID}(x + 8632)
    f === :NavJustMovedToId && return Ptr{ImGuiID}(x + 8636)
    f === :NavJustMovedToFocusScopeId && return Ptr{ImGuiID}(x + 8640)
    f === :NavJustMovedToKeyMods && return Ptr{ImGuiKeyChord}(x + 8644)
    f === :NavJustMovedToIsTabbing && return Ptr{Bool}(x + 8648)
    f === :NavJustMovedToHasSelectionData && return Ptr{Bool}(x + 8649)
    f === :ConfigNavWindowingWithGamepad && return Ptr{Bool}(x + 8650)
    f === :ConfigNavWindowingKeyNext && return Ptr{ImGuiKeyChord}(x + 8652)
    f === :ConfigNavWindowingKeyPrev && return Ptr{ImGuiKeyChord}(x + 8656)
    f === :NavWindowingTarget && return Ptr{Ptr{ImGuiWindow}}(x + 8660)
    f === :NavWindowingTargetAnim && return Ptr{Ptr{ImGuiWindow}}(x + 8664)
    f === :NavWindowingListWindow && return Ptr{Ptr{ImGuiWindow}}(x + 8668)
    f === :NavWindowingTimer && return Ptr{Cfloat}(x + 8672)
    f === :NavWindowingHighlightAlpha && return Ptr{Cfloat}(x + 8676)
    f === :NavWindowingInputSource && return Ptr{ImGuiInputSource}(x + 8680)
    f === :NavWindowingToggleLayer && return Ptr{Bool}(x + 8684)
    f === :NavWindowingToggleKey && return Ptr{ImGuiKey}(x + 8688)
    f === :NavWindowingAccumDeltaPos && return Ptr{ImVec2}(x + 8692)
    f === :NavWindowingAccumDeltaSize && return Ptr{ImVec2}(x + 8700)
    f === :DimBgRatio && return Ptr{Cfloat}(x + 8708)
    f === :DragDropActive && return Ptr{Bool}(x + 8712)
    f === :DragDropWithinSource && return Ptr{Bool}(x + 8713)
    f === :DragDropWithinTarget && return Ptr{Bool}(x + 8714)
    f === :DragDropSourceFlags && return Ptr{ImGuiDragDropFlags}(x + 8716)
    f === :DragDropSourceFrameCount && return Ptr{Cint}(x + 8720)
    f === :DragDropMouseButton && return Ptr{Cint}(x + 8724)
    f === :DragDropPayload && return Ptr{ImGuiPayload}(x + 8728)
    f === :DragDropTargetRect && return Ptr{ImRect}(x + 8784)
    f === :DragDropTargetClipRect && return Ptr{ImRect}(x + 8800)
    f === :DragDropTargetId && return Ptr{ImGuiID}(x + 8816)
    f === :DragDropTargetFullViewport && return Ptr{ImGuiID}(x + 8820)
    f === :DragDropAcceptFlagsCurr && return Ptr{ImGuiDragDropFlags}(x + 8824)
    f === :DragDropAcceptFlagsPrev && return Ptr{ImGuiDragDropFlags}(x + 8828)
    f === :DragDropAcceptIdCurrRectSurface && return Ptr{Cfloat}(x + 8832)
    f === :DragDropAcceptIdCurr && return Ptr{ImGuiID}(x + 8836)
    f === :DragDropAcceptIdPrev && return Ptr{ImGuiID}(x + 8840)
    f === :DragDropAcceptFrameCount && return Ptr{Cint}(x + 8844)
    f === :DragDropHoldJustPressedId && return Ptr{ImGuiID}(x + 8848)
    f === :DragDropPayloadBufHeap && return Ptr{ImVector_unsigned_char}(x + 8852)
    f === :DragDropPayloadBufLocal && return Ptr{NTuple{16, Cuchar}}(x + 8864)
    f === :ClipperTempDataStacked && return Ptr{Cint}(x + 8880)
    f === :ClipperTempData && return Ptr{ImVector_ImGuiListClipperData}(x + 8884)
    f === :CurrentTable && return Ptr{Ptr{ImGuiTable}}(x + 8896)
    f === :DebugBreakInTable && return Ptr{ImGuiID}(x + 8900)
    f === :TablesTempDataStacked && return Ptr{Cint}(x + 8904)
    f === :TablesTempData && return Ptr{ImVector_ImGuiTableTempData}(x + 8908)
    f === :Tables && return Ptr{ImPool_ImGuiTable}(x + 8920)
    f === :TablesLastTimeActive && return Ptr{ImVector_float}(x + 8952)
    f === :DrawChannelsTempMergeBuffer && return Ptr{ImVector_ImDrawChannel}(x + 8964)
    f === :CurrentTabBar && return Ptr{Ptr{ImGuiTabBar}}(x + 8976)
    f === :TabBars && return Ptr{ImPool_ImGuiTabBar}(x + 8980)
    f === :CurrentTabBarStack && return Ptr{ImVector_ImGuiPtrOrIndex}(x + 9012)
    f === :ShrinkWidthBuffer && return Ptr{ImVector_ImGuiShrinkWidthItem}(x + 9024)
    f === :BoxSelectState && return Ptr{ImGuiBoxSelectState}(x + 9036)
    f === :CurrentMultiSelect && return Ptr{Ptr{ImGuiMultiSelectTempData}}(x + 9132)
    f === :MultiSelectTempDataStacked && return Ptr{Cint}(x + 9136)
    f === :MultiSelectTempData && return Ptr{ImVector_ImGuiMultiSelectTempData}(x + 9140)
    f === :MultiSelectStorage && return Ptr{ImPool_ImGuiMultiSelectState}(x + 9152)
    f === :HoverItemDelayId && return Ptr{ImGuiID}(x + 9184)
    f === :HoverItemDelayIdPreviousFrame && return Ptr{ImGuiID}(x + 9188)
    f === :HoverItemDelayTimer && return Ptr{Cfloat}(x + 9192)
    f === :HoverItemDelayClearTimer && return Ptr{Cfloat}(x + 9196)
    f === :HoverItemUnlockedStationaryId && return Ptr{ImGuiID}(x + 9200)
    f === :HoverWindowUnlockedStationaryId && return Ptr{ImGuiID}(x + 9204)
    f === :MouseCursor && return Ptr{ImGuiMouseCursor}(x + 9208)
    f === :MouseStationaryTimer && return Ptr{Cfloat}(x + 9212)
    f === :MouseLastValidPos && return Ptr{ImVec2}(x + 9216)
    f === :InputTextState && return Ptr{ImGuiInputTextState}(x + 9224)
    f === :InputTextLineIndex && return Ptr{ImGuiTextIndex}(x + 9324)
    f === :InputTextDeactivatedState && return Ptr{ImGuiInputTextDeactivatedState}(x + 9340)
    f === :InputTextPasswordFontBackupBaked && return Ptr{ImFontBaked}(x + 9356)
    f === :InputTextPasswordFontBackupFlags && return Ptr{ImFontFlags}(x + 9436)
    f === :TempInputId && return Ptr{ImGuiID}(x + 9440)
    f === :DataTypeZeroValue && return Ptr{ImGuiDataTypeStorage}(x + 9444)
    f === :BeginMenuDepth && return Ptr{Cint}(x + 9452)
    f === :BeginComboDepth && return Ptr{Cint}(x + 9456)
    f === :ColorEditOptions && return Ptr{ImGuiColorEditFlags}(x + 9460)
    f === :ColorEditCurrentID && return Ptr{ImGuiID}(x + 9464)
    f === :ColorEditSavedID && return Ptr{ImGuiID}(x + 9468)
    f === :ColorEditSavedHue && return Ptr{Cfloat}(x + 9472)
    f === :ColorEditSavedSat && return Ptr{Cfloat}(x + 9476)
    f === :ColorEditSavedColor && return Ptr{ImU32}(x + 9480)
    f === :ColorPickerRef && return Ptr{ImVec4}(x + 9484)
    f === :ComboPreviewData && return Ptr{ImGuiComboPreviewData}(x + 9500)
    f === :WindowResizeBorderExpectedRect && return Ptr{ImRect}(x + 9548)
    f === :WindowResizeRelativeMode && return Ptr{Bool}(x + 9564)
    f === :ScrollbarSeekMode && return Ptr{Cshort}(x + 9566)
    f === :ScrollbarClickDeltaToGrabCenter && return Ptr{Cfloat}(x + 9568)
    f === :SliderGrabClickOffset && return Ptr{Cfloat}(x + 9572)
    f === :SliderCurrentAccum && return Ptr{Cfloat}(x + 9576)
    f === :SliderCurrentAccumDirty && return Ptr{Bool}(x + 9580)
    f === :DragCurrentAccumDirty && return Ptr{Bool}(x + 9581)
    f === :DragCurrentAccum && return Ptr{Cfloat}(x + 9584)
    f === :DragSpeedDefaultRatio && return Ptr{Cfloat}(x + 9588)
    f === :DisabledAlphaBackup && return Ptr{Cfloat}(x + 9592)
    f === :DisabledStackSize && return Ptr{Cshort}(x + 9596)
    f === :TooltipOverrideCount && return Ptr{Cshort}(x + 9598)
    f === :TooltipPreviousWindow && return Ptr{Ptr{ImGuiWindow}}(x + 9600)
    f === :ClipboardHandlerData && return Ptr{ImVector_char}(x + 9604)
    f === :MenusIdSubmittedThisFrame && return Ptr{ImVector_ImGuiID}(x + 9616)
    f === :TypingSelectState && return Ptr{ImGuiTypingSelectState}(x + 9628)
    f === :PlatformImeData && return Ptr{ImGuiPlatformImeData}(x + 9724)
    f === :PlatformImeDataPrev && return Ptr{ImGuiPlatformImeData}(x + 9744)
    f === :UserTextures && return Ptr{ImVector_ImTextureDataPtr}(x + 9764)
    f === :DockContext && return Ptr{ImGuiDockContext}(x + 9776)
    f === :DockNodeWindowMenuHandler && return Ptr{Ptr{Cvoid}}(x + 9816)
    f === :SettingsLoaded && return Ptr{Bool}(x + 9820)
    f === :SettingsDirtyTimer && return Ptr{Cfloat}(x + 9824)
    f === :SettingsIniData && return Ptr{ImGuiTextBuffer}(x + 9828)
    f === :SettingsHandlers && return Ptr{ImVector_ImGuiSettingsHandler}(x + 9840)
    f === :SettingsWindows && return Ptr{ImChunkStream_ImGuiWindowSettings}(x + 9852)
    f === :SettingsTables && return Ptr{ImChunkStream_ImGuiTableSettings}(x + 9864)
    f === :Hooks && return Ptr{ImVector_ImGuiContextHook}(x + 9876)
    f === :HookIdNext && return Ptr{ImGuiID}(x + 9888)
    f === :LocalizationTable && return Ptr{NTuple{13, Ptr{Cchar}}}(x + 9892)
    f === :LogEnabled && return Ptr{Bool}(x + 9944)
    f === :LogLineFirstItem && return Ptr{Bool}(x + 9945)
    f === :LogFlags && return Ptr{ImGuiLogFlags}(x + 9948)
    f === :LogWindow && return Ptr{Ptr{ImGuiWindow}}(x + 9952)
    f === :LogFile && return Ptr{ImFileHandle}(x + 9956)
    f === :LogBuffer && return Ptr{ImGuiTextBuffer}(x + 9960)
    f === :LogNextPrefix && return Ptr{Ptr{Cchar}}(x + 9972)
    f === :LogNextSuffix && return Ptr{Ptr{Cchar}}(x + 9976)
    f === :LogLinePosY && return Ptr{Cfloat}(x + 9980)
    f === :LogDepthRef && return Ptr{Cint}(x + 9984)
    f === :LogDepthToExpand && return Ptr{Cint}(x + 9988)
    f === :LogDepthToExpandDefault && return Ptr{Cint}(x + 9992)
    f === :ErrorCallback && return Ptr{ImGuiErrorCallback}(x + 9996)
    f === :ErrorCallbackUserData && return Ptr{Ptr{Cvoid}}(x + 10000)
    f === :ErrorTooltipLockedPos && return Ptr{ImVec2}(x + 10004)
    f === :ErrorFirst && return Ptr{Bool}(x + 10012)
    f === :ErrorCountCurrentFrame && return Ptr{Cint}(x + 10016)
    f === :StackSizesInNewFrame && return Ptr{ImGuiErrorRecoveryState}(x + 10020)
    f === :StackSizesInBeginForCurrentWindow && return Ptr{Ptr{ImGuiErrorRecoveryState}}(x + 10044)
    f === :DebugDrawIdConflictsCount && return Ptr{Cint}(x + 10048)
    f === :DebugLogFlags && return Ptr{ImGuiDebugLogFlags}(x + 10052)
    f === :DebugLogBuf && return Ptr{ImGuiTextBuffer}(x + 10056)
    f === :DebugLogIndex && return Ptr{ImGuiTextIndex}(x + 10068)
    f === :DebugLogSkippedErrors && return Ptr{Cint}(x + 10084)
    f === :DebugLogAutoDisableFlags && return Ptr{ImGuiDebugLogFlags}(x + 10088)
    f === :DebugLogAutoDisableFrames && return Ptr{ImU8}(x + 10092)
    f === :DebugLocateFrames && return Ptr{ImU8}(x + 10093)
    f === :DebugBreakInLocateId && return Ptr{Bool}(x + 10094)
    f === :DebugBreakKeyChord && return Ptr{ImGuiKeyChord}(x + 10096)
    f === :DebugBeginReturnValueCullDepth && return Ptr{ImS8}(x + 10100)
    f === :DebugItemPickerActive && return Ptr{Bool}(x + 10101)
    f === :DebugItemPickerMouseButton && return Ptr{ImU8}(x + 10102)
    f === :DebugItemPickerBreakId && return Ptr{ImGuiID}(x + 10104)
    f === :DebugFlashStyleColorTime && return Ptr{Cfloat}(x + 10108)
    f === :DebugFlashStyleColorBackup && return Ptr{ImVec4}(x + 10112)
    f === :DebugMetricsConfig && return Ptr{ImGuiMetricsConfig}(x + 10128)
    f === :DebugItemPathQuery && return Ptr{ImGuiDebugItemPathQuery}(x + 10160)
    f === :DebugIDStackTool && return Ptr{ImGuiIDStackTool}(x + 10204)
    f === :DebugAllocInfo && return Ptr{ImGuiDebugAllocInfo}(x + 10216)
    f === :DebugHoveredDockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 10276)
    f === :FramerateSecPerFrame && return Ptr{NTuple{60, Cfloat}}(x + 10280)
    f === :FramerateSecPerFrameIdx && return Ptr{Cint}(x + 10520)
    f === :FramerateSecPerFrameCount && return Ptr{Cint}(x + 10524)
    f === :FramerateSecPerFrameAccum && return Ptr{Cfloat}(x + 10528)
    f === :WantCaptureMouseNextFrame && return Ptr{Cint}(x + 10532)
    f === :WantCaptureKeyboardNextFrame && return Ptr{Cint}(x + 10536)
    f === :WantTextInputNextFrame && return Ptr{Cint}(x + 10540)
    f === :TempBuffer && return Ptr{ImVector_char}(x + 10544)
    f === :TempKeychordName && return Ptr{NTuple{64, Cchar}}(x + 10556)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiInputTextCallbackData}, f::Symbol)
    ...
    f === :EventChar && return Ptr{ImWchar}(x + 16)
    f === :EventKey && return Ptr{ImGuiKey}(x + 20)
    f === :Buf && return Ptr{Ptr{Cchar}}(x + 24)
    f === :BufTextLen && return Ptr{Cint}(x + 28)
    f === :BufSize && return Ptr{Cint}(x + 32)
    f === :BufDirty && return Ptr{Bool}(x + 36)
...
function Base.getproperty(x::Ptr{ImPlotContext}, f::Symbol)
    ...
    f === :ColorModifiers && return Ptr{ImVector_ImGuiColorMod}(x + 700)
    f === :StyleModifiers && return Ptr{ImVector_ImGuiStyleMod}(x + 712)
    f === :ColormapData && return Ptr{ImPlotColormapData}(x + 724)
    f === :ColormapModifiers && return Ptr{ImVector_ImPlotColormap}(x + 848)
    f === :Tm && return Ptr{tm}(x + 860)
    f === :TempDouble1 && return Ptr{ImVector_double}(x + 896)
    f === :TempDouble2 && return Ptr{ImVector_double}(x + 908)
    f === :TempInt1 && return Ptr{ImVector_int}(x + 920)
    f === :DigitalPlotItemCnt && return Ptr{Cint}(x + 932)
    f === :DigitalPlotOffset && return Ptr{Cint}(x + 936)
    f === :NextPlotData && return Ptr{ImPlotNextPlotData}(x + 944)
    f === :NextItemData && return Ptr{ImPlotNextItemData}(x + 1128)
    f === :InputMap && return Ptr{ImPlotInputMap}(x + 1256)
    f === :OpenContextThisFrame && return Ptr{Bool}(x + 1304)
    f === :MousePosStringBuilder && return Ptr{ImGuiTextBuffer}(x + 1308)
    f === :SortItems && return Ptr{Ptr{ImPlotItemGroup}}(x + 1320)
    f === :AlignmentData && return Ptr{ImPool_ImPlotAlignmentData}(x + 1324)
    f === :CurrentAlignmentH && return Ptr{Ptr{ImPlotAlignmentData}}(x + 1356)
    f === :CurrentAlignmentV && return Ptr{Ptr{ImPlotAlignmentData}}(x + 1360)
    return getfield(x, f)
end
