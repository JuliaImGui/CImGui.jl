...
function Base.getproperty(x::Ptr{ImTextureData}, f::Symbol)
    ...
    f === :TexID && return Ptr{ImTextureID}(x + 12)
    f === :Format && return Ptr{ImTextureFormat}(x + 20)
    f === :Width && return Ptr{Cint}(x + 24)
    f === :Height && return Ptr{Cint}(x + 28)
    f === :BytesPerPixel && return Ptr{Cint}(x + 32)
    f === :Pixels && return Ptr{Ptr{Cuchar}}(x + 36)
    f === :UsedRect && return Ptr{ImTextureRect}(x + 40)
    f === :UpdateRect && return Ptr{ImTextureRect}(x + 48)
    f === :Updates && return Ptr{ImVector_ImTextureRect}(x + 56)
    f === :UnusedFrames && return Ptr{Cint}(x + 68)
    f === :RefCount && return Ptr{Cushort}(x + 72)
    f === :UseColors && return Ptr{Bool}(x + 74)
    f === :WantDestroyNextFrame && return Ptr{Bool}(x + 75)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiIO}, f::Symbol)
    ...
    f === :MouseReleasedTime && return Ptr{NTuple{5, Cdouble}}(x + 2828)
    f === :MouseDownOwned && return Ptr{NTuple{5, Bool}}(x + 2868)
    f === :MouseDownOwnedUnlessPopupClose && return Ptr{NTuple{5, Bool}}(x + 2873)
    f === :MouseWheelRequestAxisSwap && return Ptr{Bool}(x + 2878)
    f === :MouseCtrlLeftAsRightClick && return Ptr{Bool}(x + 2879)
    ...
    f === :InputQueueCharacters && return Ptr{ImVector_ImWchar}(x + 2988)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiDockNode}, f::Symbol)
    ...
    f === :IsVisible && return (Ptr{Bool}(x + 168), 9, 1)
    f === :IsFocused && return (Ptr{Bool}(x + 168), 10, 1)
    f === :IsBgDrawnThisFrame && return (Ptr{Bool}(x + 168), 11, 1)
    f === :HasCloseButton && return (Ptr{Bool}(x + 168), 12, 1)
    f === :HasWindowMenuButton && return (Ptr{Bool}(x + 168), 13, 1)
    f === :HasCentralNodeChild && return (Ptr{Bool}(x + 168), 14, 1)
    f === :WantCloseAll && return (Ptr{Bool}(x + 168), 15, 1)
    f === :WantLockSizeOnce && return (Ptr{Bool}(x + 168), 16, 1)
    f === :WantMouseMove && return (Ptr{Bool}(x + 168), 17, 1)
    f === :WantHiddenTabBarUpdate && return (Ptr{Bool}(x + 168), 18, 1)
    f === :WantHiddenTabBarToggle && return (Ptr{Bool}(x + 168), 19, 1)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    ...
    f === :PlatformIO && return Ptr{ImGuiPlatformIO}(x + 3044)
    f === :Style && return Ptr{ImGuiStyle}(x + 3236)
    f === :ConfigFlagsCurrFrame && return Ptr{ImGuiConfigFlags}(x + 4592)
    f === :ConfigFlagsLastFrame && return Ptr{ImGuiConfigFlags}(x + 4596)
    f === :FontAtlases && return Ptr{ImVector_ImFontAtlasPtr}(x + 4600)
    f === :Font && return Ptr{Ptr{ImFont}}(x + 4612)
    f === :FontBaked && return Ptr{Ptr{ImFontBaked}}(x + 4616)
    f === :FontSize && return Ptr{Cfloat}(x + 4620)
    f === :FontSizeBase && return Ptr{Cfloat}(x + 4624)
    f === :FontBakedScale && return Ptr{Cfloat}(x + 4628)
    f === :FontRasterizerDensity && return Ptr{Cfloat}(x + 4632)
    f === :CurrentDpiScale && return Ptr{Cfloat}(x + 4636)
    f === :DrawListSharedData && return Ptr{ImDrawListSharedData}(x + 4640)
    f === :WithinEndChildID && return Ptr{ImGuiID}(x + 5180)
    f === :WithinEndPopupID && return Ptr{ImGuiID}(x + 5184)
    f === :TestEngine && return Ptr{Ptr{Cvoid}}(x + 5188)
    f === :InputEventsQueue && return Ptr{ImVector_ImGuiInputEvent}(x + 5192)
    f === :InputEventsTrail && return Ptr{ImVector_ImGuiInputEvent}(x + 5204)
    f === :InputEventsNextMouseSource && return Ptr{ImGuiMouseSource}(x + 5216)
    f === :InputEventsNextEventId && return Ptr{ImU32}(x + 5220)
    f === :Windows && return Ptr{ImVector_ImGuiWindowPtr}(x + 5224)
    f === :WindowsFocusOrder && return Ptr{ImVector_ImGuiWindowPtr}(x + 5236)
    f === :WindowsTempSortBuffer && return Ptr{ImVector_ImGuiWindowPtr}(x + 5248)
    f === :CurrentWindowStack && return Ptr{ImVector_ImGuiWindowStackData}(x + 5260)
    f === :WindowsById && return Ptr{ImGuiStorage}(x + 5272)
    f === :WindowsActiveCount && return Ptr{Cint}(x + 5284)
    f === :WindowsBorderHoverPadding && return Ptr{Cfloat}(x + 5288)
    f === :DebugBreakInWindow && return Ptr{ImGuiID}(x + 5292)
    f === :CurrentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5296)
    f === :HoveredWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5300)
    f === :HoveredWindowUnderMovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5304)
    f === :HoveredWindowBeforeClear && return Ptr{Ptr{ImGuiWindow}}(x + 5308)
    f === :MovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5312)
    f === :WheelingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5316)
    f === :WheelingWindowRefMousePos && return Ptr{ImVec2}(x + 5320)
    f === :WheelingWindowStartFrame && return Ptr{Cint}(x + 5328)
    f === :WheelingWindowScrolledFrame && return Ptr{Cint}(x + 5332)
    f === :WheelingWindowReleaseTimer && return Ptr{Cfloat}(x + 5336)
    f === :WheelingWindowWheelRemainder && return Ptr{ImVec2}(x + 5340)
    f === :WheelingAxisAvg && return Ptr{ImVec2}(x + 5348)
    f === :DebugDrawIdConflictsId && return Ptr{ImGuiID}(x + 5356)
    f === :DebugHookIdInfoId && return Ptr{ImGuiID}(x + 5360)
    f === :HoveredId && return Ptr{ImGuiID}(x + 5364)
    f === :HoveredIdPreviousFrame && return Ptr{ImGuiID}(x + 5368)
    f === :HoveredIdPreviousFrameItemCount && return Ptr{Cint}(x + 5372)
    f === :HoveredIdTimer && return Ptr{Cfloat}(x + 5376)
    f === :HoveredIdNotActiveTimer && return Ptr{Cfloat}(x + 5380)
    f === :HoveredIdAllowOverlap && return Ptr{Bool}(x + 5384)
    f === :HoveredIdIsDisabled && return Ptr{Bool}(x + 5385)
    f === :ItemUnclipByLog && return Ptr{Bool}(x + 5386)
    f === :ActiveId && return Ptr{ImGuiID}(x + 5388)
    f === :ActiveIdIsAlive && return Ptr{ImGuiID}(x + 5392)
    f === :ActiveIdTimer && return Ptr{Cfloat}(x + 5396)
    f === :ActiveIdIsJustActivated && return Ptr{Bool}(x + 5400)
    f === :ActiveIdAllowOverlap && return Ptr{Bool}(x + 5401)
    f === :ActiveIdNoClearOnFocusLoss && return Ptr{Bool}(x + 5402)
    f === :ActiveIdHasBeenPressedBefore && return Ptr{Bool}(x + 5403)
    f === :ActiveIdHasBeenEditedBefore && return Ptr{Bool}(x + 5404)
    f === :ActiveIdHasBeenEditedThisFrame && return Ptr{Bool}(x + 5405)
    f === :ActiveIdFromShortcut && return Ptr{Bool}(x + 5406)
    f === :ActiveIdMouseButton && return Ptr{ImS8}(x + 5407)
    f === :ActiveIdDisabledId && return Ptr{ImGuiID}(x + 5408)
    f === :ActiveIdClickOffset && return Ptr{ImVec2}(x + 5412)
    f === :ActiveIdSource && return Ptr{ImGuiInputSource}(x + 5420)
    f === :ActiveIdWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5424)
    f === :ActiveIdPreviousFrame && return Ptr{ImGuiID}(x + 5428)
    f === :DeactivatedItemData && return Ptr{ImGuiDeactivatedItemData}(x + 5432)
    f === :ActiveIdValueOnActivation && return Ptr{ImGuiDataTypeStorage}(x + 5444)
    f === :LastActiveId && return Ptr{ImGuiID}(x + 5452)
    f === :LastActiveIdTimer && return Ptr{Cfloat}(x + 5456)
    f === :LastKeyModsChangeTime && return Ptr{Cdouble}(x + 5460)
    f === :LastKeyModsChangeFromNoneTime && return Ptr{Cdouble}(x + 5468)
    f === :LastKeyboardKeyPressTime && return Ptr{Cdouble}(x + 5476)
    f === :KeysMayBeCharInput && return Ptr{ImBitArrayForNamedKeys}(x + 5484)
    f === :KeysOwnerData && return Ptr{NTuple{155, ImGuiKeyOwnerData}}(x + 5504)
    f === :KeysRoutingTable && return Ptr{ImGuiKeyRoutingTable}(x + 