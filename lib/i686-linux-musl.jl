...
function Base.getproperty(x::Ptr{ImGuiViewport}, f::Symbol)
    ...
    f === :RendererUserData && return Ptr{Ptr{Cvoid}}(x + 60)
    f === :PlatformUserData && return Ptr{Ptr{Cvoid}}(x + 64)
    f === :PlatformHandle && return Ptr{Ptr{Cvoid}}(x + 68)
    f === :PlatformHandleRaw && return Ptr{Ptr{Cvoid}}(x + 72)
    f === :PlatformWindowCreated && return Ptr{Bool}(x + 76)
    f === :PlatformRequestMove && return Ptr{Bool}(x + 77)
    f === :PlatformRequestResize && return Ptr{Bool}(x + 78)
    f === :PlatformRequestClose && return Ptr{Bool}(x + 79)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{ImFontBaked}, f::Symbol)
    ...
    f === :LockLoadingFallback && return (Ptr{Cuint}(x + 60), 27, 1)
    f === :LastUsedFrame && return Ptr{Cint}(x + 64)
    f === :BakedId && return Ptr{ImGuiID}(x + 68)
    f === :ContainerFont && return Ptr{Ptr{ImFont}}(x + 72)
...
function Base.getproperty(x::Ptr{ImGuiIO}, f::Symbol)
    ...
    f === :ConfigDpiScaleFonts && return Ptr{Bool}(x + 68)
    f === :ConfigDpiScaleViewports && return Ptr{Bool}(x + 69)
    f === :MouseDrawCursor && return Ptr{Bool}(x + 70)
    f === :ConfigMacOSXBehaviors && return Ptr{Bool}(x + 71)
    f === :ConfigInputTrickleEventQueue && return Ptr{Bool}(x + 72)
    f === :ConfigInputTextCursorBlink && return Ptr{Bool}(x + 73)
    f === :ConfigInputTextEnterKeepActive && return Ptr{Bool}(x + 74)
    f === :ConfigDragClickToInputText && return Ptr{Bool}(x + 75)
    f === :ConfigWindowsResizeFromEdges && return Ptr{Bool}(x + 76)
    f === :ConfigWindowsMoveFromTitleBarOnly && return Ptr{Bool}(x + 77)
    f === :ConfigWindowsCopyContentsWithCtrlC && return Ptr{Bool}(x + 78)
    f === :ConfigScrollbarScrollByPage && return Ptr{Bool}(x + 79)
    ...
    f === :ConfigErrorRecovery && return Ptr{Bool}(x + 104)
    f === :ConfigErrorRecoveryEnableAssert && return Ptr{Bool}(x + 105)
    f === :ConfigErrorRecoveryEnableDebugLog && return Ptr{Bool}(x + 106)
    f === :ConfigErrorRecoveryEnableTooltip && return Ptr{Bool}(x + 107)
    f === :ConfigDebugIsDebuggerPresent && return Ptr{Bool}(x + 108)
    f === :ConfigDebugHighlightIdConflicts && return Ptr{Bool}(x + 109)
    f === :ConfigDebugHighlightIdConflictsShowItemPicker && return Ptr{Bool}(x + 110)
    f === :ConfigDebugBeginReturnValueOnce && return Ptr{Bool}(x + 111)
    f === :ConfigDebugBeginReturnValueLoop && return Ptr{Bool}(x + 112)
    f === :ConfigDebugIgnoreFocusLoss && return Ptr{Bool}(x + 113)
    f === :ConfigDebugIniSettings && return Ptr{Bool}(x + 114)
    f === :BackendPlatformName && return Ptr{Ptr{Cchar}}(x + 116)
    f === :BackendRendererName && return Ptr{Ptr{Cchar}}(x + 120)
    f === :BackendPlatformUserData && return Ptr{Ptr{Cvoid}}(x + 124)
    f === :BackendRendererUserData && return Ptr{Ptr{Cvoid}}(x + 128)
    f === :BackendLanguageUserData && return Ptr{Ptr{Cvoid}}(x + 132)
    f === :WantCaptureMouse && return Ptr{Bool}(x + 136)
    f === :WantCaptureKeyboard && return Ptr{Bool}(x + 137)
    f === :WantTextInput && return Ptr{Bool}(x + 138)
    f === :WantSetMousePos && return Ptr{Bool}(x + 139)
    f === :WantSaveIniSettings && return Ptr{Bool}(x + 140)
    f === :NavActive && return Ptr{Bool}(x + 141)
    f === :NavVisible && return Ptr{Bool}(x + 142)
    f === :Framerate && return Ptr{Cfloat}(x + 144)
    f === :MetricsRenderVertices && return Ptr{Cint}(x + 148)
    f === :MetricsRenderIndices && return Ptr{Cint}(x + 152)
    f === :MetricsRenderWindows && return Ptr{Cint}(x + 156)
    f === :MetricsActiveWindows && return Ptr{Cint}(x + 160)
    f === :MouseDelta && return Ptr{ImVec2}(x + 164)
    f === :Ctx && return Ptr{Ptr{ImGuiContext}}(x + 172)
    f === :MousePos && return Ptr{ImVec2}(x + 176)
    f === :MouseDown && return Ptr{NTuple{5, Bool}}(x + 184)
    f === :MouseWheel && return Ptr{Cfloat}(x + 192)
    f === :MouseWheelH && return Ptr{Cfloat}(x + 196)
    f === :MouseSource && return Ptr{ImGuiMouseSource}(x + 200)
    f === :MouseHoveredViewport && return Ptr{ImGuiID}(x + 204)
    f === :KeyCtrl && return Ptr{Bool}(x + 208)
    f === :KeyShift && return Ptr{Bool}(x + 209)
    f === :KeyAlt && return Ptr{Bool}(x + 210)
    f === :KeySuper && return Ptr{Bool}(x + 211)
    f === :KeyMods && return Ptr{ImGuiKeyChord}(x + 212)
    f === :KeysData && return Ptr{NTuple{155, ImGuiKeyData}}(x + 216)
    f === :WantCaptureMouseUnlessPopupClose && return Ptr{Bool}(x + 2696)
    f === :MousePosPrev && return Ptr{ImVec2}(x + 2700)
    f === :MouseClickedPos && return Ptr{NTuple{5, ImVec2}}(x + 2708)
    f === :MouseClickedTime && return Ptr{NTuple{5, Cdouble}}(x + 2748)
    f === :MouseClicked && return Ptr{NTuple{5, Bool}}(x + 2788)
    f === :MouseDoubleClicked && return Ptr{NTuple{5, Bool}}(x + 2793)
    f === :MouseClickedCount && return Ptr{NTuple{5, ImU16}}(x + 2798)
    f === :MouseClickedLastCount && return Ptr{NTuple{5, ImU16}}(x + 2808)
    f === :MouseReleased && return Ptr{NTuple{5, Bool}}(x + 2818)
    f === :MouseReleasedTime && return Ptr{NTuple{5, Cdouble}}(x + 2824)
    f === :MouseDownOwned && return Ptr{NTuple{5, Bool}}(x + 2864)
    f === :MouseDownOwnedUnlessPopupClose && return Ptr{NTuple{5, Bool}}(x + 2869)
    f === :MouseWheelRequestAxisSwap && return Ptr{Bool}(x + 2874)
    f === :MouseCtrlLeftAsRightClick && return Ptr{Bool}(x + 2875)
    f === :MouseDownDuration && return Ptr{NTuple{5, Cfloat}}(x + 2876)
    f === :MouseDownDurationPrev && return Ptr{NTuple{5, Cfloat}}(x + 2896)
    f === :MouseDragMaxDistanceAbs && return Ptr{NTuple{5, ImVec2}}(x + 2916)
    f === :MouseDragMaxDistanceSqr && return Ptr{NTuple{5, Cfloat}}(x + 2956)
    f === :PenPressure && return Ptr{Cfloat}(x + 2976)
    f === :AppFocusLost && return Ptr{Bool}(x + 2980)
    f === :AppAcceptingEvents && return Ptr{Bool}(x + 2981)
    f === :InputQueueSurrogate && return Ptr{ImWchar16}(x + 2982)
...
function Base.getproperty(x::Ptr{ImGuiWindow}, f::Symbol)
    ...
    f === :AutoFitFramesX && return Ptr{ImS8}(x + 270)
    f === :AutoFitFramesY && return Ptr{ImS8}(x + 271)
    f === :AutoFitOnlyGrows && return Ptr{Bool}(x + 272)
    f === :AutoPosLastDirection && return Ptr{ImGuiDir}(x + 276)
    f === :HiddenFramesCanSkipItems && return Ptr{ImS8}(x + 280)
    f === :HiddenFramesCannotSkipItems && return Ptr{ImS8}(x + 281)
    f === :HiddenFramesForRenderOnly && return Ptr{ImS8}(x + 282)
    f === :DisableInputsFrames && return Ptr{ImS8}(x + 283)
    ...
    f === :DockNode && return Ptr{Ptr{ImGuiDockNode}}(x + 1044)
    f === :DockNodeAsHost && return Ptr{Ptr{ImGuiDockNode}}(x + 1048)
    f === :DockId && return Ptr{ImGuiID}(x + 1052)
    return getfield(x, f)
end
...
struct ImGuiContext
    data::NTuple{10460, UInt8}
end

function Base.getproperty(x::Ptr{ImGuiContext}, f::Symbol)
    f === :Initialized && return Ptr{Bool}(x + 0)
    f === :IO && return Ptr{ImGuiIO}(x + 4)
    f === :PlatformIO && return Ptr{ImGuiPlatformIO}(x + 3000)
    f === :Style && return Ptr{ImGuiStyle}(x + 3180)
    f === :ConfigFlagsCurrFrame && return Ptr{ImGuiConfigFlags}(x + 4448)
    f === :ConfigFlagsLastFrame && return Ptr{ImGuiConfigFlags}(x + 4452)
    f === :FontAtlases && return Ptr{ImVector_ImFontAtlasPtr}(x + 4456)
    f === :Font && return Ptr{Ptr{ImFont}}(x + 4468)
    f === :FontBaked && return Ptr{Ptr{ImFontBaked}}(x + 4472)
    f === :FontSize && return Ptr{Cfloat}(x + 4476)
    f === :FontSizeBase && return Ptr{Cfloat}(x + 4480)
    f === :FontBakedScale && return Ptr{Cfloat}(x + 4484)
    f === :FontRasterizerDensity && return Ptr{Cfloat}(x + 4488)
    f === :CurrentDpiScale && return Ptr{Cfloat}(x + 4492)
    f === :DrawListSharedData && return Ptr{ImDrawListSharedData}(x + 4496)
    f === :Time && return Ptr{Cdouble}(x + 5036)
    f === :FrameCount && return Ptr{Cint}(x + 5044)
    f === :FrameCountEnded && return Ptr{Cint}(x + 5048)
    f === :FrameCountPlatformEnded && return Ptr{Cint}(x + 5052)
    f === :FrameCountRendered && return Ptr{Cint}(x + 5056)
    f === :WithinEndChildID && return Ptr{ImGuiID}(x + 5060)
    f === :WithinFrameScope && return Ptr{Bool}(x + 5064)
    f === :WithinFrameScopeWithImplicitWindow && return Ptr{Bool}(x + 5065)
    f === :GcCompactAll && return Ptr{Bool}(x + 5066)
    f === :TestEngineHookItems && return Ptr{Bool}(x + 5067)
    f === :TestEngine && return Ptr{Ptr{Cvoid}}(x + 5068)
    f === :ContextName && return Ptr{NTuple{16, Cchar}}(x + 5072)
    f === :InputEventsQueue && return Ptr{ImVector_ImGuiInputEvent}(x + 5088)
    f === :InputEventsTrail && return Ptr{ImVector_ImGuiInputEvent}(x + 5100)
    f === :InputEventsNextMouseSource && return Ptr{ImGuiMouseSource}(x + 5112)
    f === :InputEventsNextEventId && return Ptr{ImU32}(x + 5116)
    f === :Windows && return Ptr{ImVector_ImGuiWindowPtr}(x + 5120)
    f === :WindowsFocusOrder && return Ptr{ImVector_ImGuiWindowPtr}(x + 5132)
    f === :WindowsTempSortBuffer && return Ptr{ImVector_ImGuiWindowPtr}(x + 5144)
    f === :CurrentWindowStack && return Ptr{ImVector_ImGuiWindowStackData}(x + 5156)
    f === :WindowsById && return Ptr{ImGuiStorage}(x + 5168)
    f === :WindowsActiveCount && return Ptr{Cint}(x + 5180)
    f === :WindowsBorderHoverPadding && return Ptr{Cfloat}(x + 5184)
    f === :DebugBreakInWindow && return Ptr{ImGuiID}(x + 5188)
    f === :CurrentWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5192)
    f === :HoveredWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5196)
    f === :HoveredWindowUnderMovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5200)
    f === :HoveredWindowBeforeClear && return Ptr{Ptr{ImGuiWindow}}(x + 5204)
    f === :MovingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5208)
    f === :WheelingWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5212)
    f === :WheelingWindowRefMousePos && return Ptr{ImVec2}(x + 5216)
    f === :WheelingWindowStartFrame && return Ptr{Cint}(x + 5224)
    f === :WheelingWindowScrolledFrame && return Ptr{Cint}(x + 5228)
    f === :WheelingWindowReleaseTimer && return Ptr{Cfloat}(x + 5232)
    f === :WheelingWindowWheelRemainder && return Ptr{ImVec2}(x + 5236)
    f === :WheelingAxisAvg && return Ptr{ImVec2}(x + 5244)
    f === :DebugDrawIdConflictsId && return Ptr{ImGuiID}(x + 5252)
    f === :DebugHookIdInfo && return Ptr{ImGuiID}(x + 5256)
    f === :HoveredId && return Ptr{ImGuiID}(x + 5260)
    f === :HoveredIdPreviousFrame && return Ptr{ImGuiID}(x + 5264)
    f === :HoveredIdPreviousFrameItemCount && return Ptr{Cint}(x + 5268)
    f === :HoveredIdTimer && return Ptr{Cfloat}(x + 5272)
    f === :HoveredIdNotActiveTimer && return Ptr{Cfloat}(x + 5276)
    f === :HoveredIdAllowOverlap && return Ptr{Bool}(x + 5280)
    f === :HoveredIdIsDisabled && return Ptr{Bool}(x + 5281)
    f === :ItemUnclipByLog && return Ptr{Bool}(x + 5282)
    f === :ActiveId && return Ptr{ImGuiID}(x + 5284)
    f === :ActiveIdIsAlive && return Ptr{ImGuiID}(x + 5288)
    f === :ActiveIdTimer && return Ptr{Cfloat}(x + 5292)
    f === :ActiveIdIsJustActivated && return Ptr{Bool}(x + 5296)
    f === :ActiveIdAllowOverlap && return Ptr{Bool}(x + 5297)
    f === :ActiveIdNoClearOnFocusLoss && return Ptr{Bool}(x + 5298)
    f === :ActiveIdHasBeenPressedBefore && return Ptr{Bool}(x + 5299)
    f === :ActiveIdHasBeenEditedBefore && return Ptr{Bool}(x + 5300)
    f === :ActiveIdHasBeenEditedThisFrame && return Ptr{Bool}(x + 5301)
    f === :ActiveIdFromShortcut && return Ptr{Bool}(x + 5302)
    f === :ActiveIdMouseButton && return (Ptr{Cint}(x + 5300), 24, 8)
    f === :ActiveIdClickOffset && return Ptr{ImVec2}(x + 5304)
    f === :ActiveIdWindow && return Ptr{Ptr{ImGuiWindow}}(x + 5312)
    f === :ActiveIdSource && return Ptr{ImGuiInputSource}(x + 5316)
    f === :ActiveIdPreviousFrame && return Ptr{ImGuiID}(x + 5320)
    f === :DeactivatedItemData && return Ptr{ImGuiDeactivatedItemData}(x + 5324)
    f === :ActiveIdValueOnActivation && return Ptr{ImGuiDataTypeStorage}(x + 5336)
    f === :LastActiveId && return Ptr{ImGuiID}(x + 5344)
    f === :LastActiveIdTimer && return Ptr{Cfloat}(x + 5348)
    f === :LastKeyModsChangeTime && return Ptr{Cdouble}(x + 5352)
    f === :LastKeyModsChangeFromNoneTime && return Ptr{Cdouble}(x + 5360)
    f === :LastKeyboardKeyPressTime && return Ptr{Cdouble}(x + 5368)
    f === :KeysMayBeCharInput && return Ptr{ImBitArrayForNamedKeys}(x + 5376)
    f === :KeysOwnerData && return Ptr{NTuple{155, ImGuiKeyOwnerData}}(x + 5396)
    f === :KeysRoutingTable && return Ptr{ImGuiKeyRoutingTable}(x + 7256)
    f === :ActiveIdUsingNavDirMask && return Ptr{ImU32}(x + 7592)
    f === :ActiveIdUsingAllKeyboardKeys && return Ptr{Bool}(x + 7596)
    f === :DebugBreakInShortcutRouting && return Ptr{ImGuiKeyChord}(x + 7600)
    f === :CurrentFocusScopeId && return Ptr{ImGuiID}(x + 7604)
    f === :CurrentItemFlags && return Ptr{ImGuiItemFlags}(x + 7608)
    f === :DebugLocateId && return Ptr{ImGuiID}(x + 7612)
    f === :NextItemData && return Ptr{ImGuiNextItemData}(x + 7616)
    f === :LastItemData && return Ptr{ImGuiLastItemData}(x + 7664)
    f === :NextWindowData && return Ptr{ImGuiNextWindowData}(x + 7744)
    f === :DebugShowGroupRects && return Ptr{Bool}(x + 7896)
    f === :DebugFlashStyleColorIdx && return Ptr{ImGuiCol}(x + 7900)
    f === :ColorStack && return Ptr{ImVector_ImGuiColorMod}(x + 7904)
    f === :StyleVarStack && return Ptr{ImVector_ImGuiStyleMod}(x + 7916)
    f === :FontStack && return Ptr{ImVector_ImFontStackData}(x + 7928)
    f === :FocusScopeStack && return Ptr{ImVector_ImGuiFocusScopeData}(x + 